- [**（一）免责声明：**](#免责声明)
- [**（二）背景介绍：**](#背景介绍)
  * [**想为Proof of Stake生态带来什么价值：**](#想为Proof of Stake生态带来什么价值)
- [**（三）PoS Token设计综述：**](#PoS Token设计综述)
  * [**设计细节：**](#设计细节)
- [**（四）如何获得PoS Token**](#如何获得PoS Token)
  * [**启动阶段：**](#启动阶段)
  * [**初始阶段：**](#初始阶段)
  * [**扩大阶段：**](#扩大阶段)
- [**（五）PoS代币的价值场景**](#PoS代币的价值场景)
  * [**协助PoS项目社区发展场景（社会意义）**](#协助PoS项目社区发展场景)
  * [**个人能获得的价值场景（权益）**](#个人能获得的价值场景)
- [**（六）PoS Token的代币（PoS）分发及总量**](#PoS Token的代币 )
